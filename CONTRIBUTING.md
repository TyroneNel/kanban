...
Kanban currently supports Cline, Claude, Codex, Droid, Kiro, Grok Build, and Pi as launch-supported runtime agents, and runs on macOS, Linux, and Windows. The surface area for cross-compatibility issues is large, and that's where contributions have the most impact.
