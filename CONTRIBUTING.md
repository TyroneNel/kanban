...
Kanban currently supports Cline, Cline CLI, Claude, Codex, Droid, and Kiro as launch-supported runtime agents, and runs on macOS, Linux, and Windows. The surface area for cross-compatibility issues is large, and that's where contributions have the most impact.
