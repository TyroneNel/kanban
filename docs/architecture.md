...
| CLI-backed task terminal | Claude Code, Codex, Gemini, OpenCode, Droid, Kiro, Grok Build, Pi, and similar agents | task-scoped | PTY-backed process runtime | these agents are command-driven CLIs and already fit the terminal model well |
...
This is the path for Claude Code, Codex, Gemini, OpenCode, Droid, Kiro, Grok Build, Pi, and any other command-driven agent.
...
| --- | --- | --- |
| task startup for Claude Code, Codex, Gemini, OpenCode, Droid, Kiro, Grok Build, or Pi | the PTY runtime and agent launch path | accidentally adding special logic to the Cline path |
